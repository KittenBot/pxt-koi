...
//% groups='["Basic", "Graphic", Classifier", "Tag/Code", "Audio", "Face", "Hand", "Wifi", "CloudAI"]'
namespace koi {
    type EvtAct = () => void
    ...
    let faceMaskMainX = 0
    let faceMaskMainY = 0
    let faceMaskMainState = 0

    let faceAttrNumCount = 0
    let faceAttrNumMen = 0
    let faceAttrNumWomen = 0
    let faceAttrNumOM = 0
    let faceAttrNumSmile = 0
    let faceAttrNumGlasses = 0
    let faceAttrMainX = 0
    let faceAttrMainY = 0
    let faceAttrMainGender = false
    let faceAttrMainOM = false
    ...
    export enum FaceAttrNumMenu {
        ...
        //% block=AttrNumSmile
        AttrNumSmile = 5,
        //% block=AttrNumGlasses
        AttrNumGlasses = 6,
    }
    export enum FaceAttrMainXY {
        //% block=AttrMainX
        AttrMainX = 7,
        //% block=AttrMainY
        AttrMainY = 8
    ...
    export enum FaceAttrMain {
        //% block=AttrMainGender
        AttrMainGender = 9,
        //% block=AttrMainOM
        AttrMainOM = 10,
        //% block=AttrMainSmile
        ...
        if (a.charAt(0) == 'K') {
            ...
            if (cmd == 42) {
                ...
                try{
                    ...
                    faceAttrNumWomen = faceAttrNumCount - faceAttrNumMen
                    faceAttrNumOM = parseInt(data[3])
                    faceAttrNumSmile = parseInt(data[4])
                    faceAttrNumGlasses = parseInt(data[5])
                    faceAttrMainX = parseInt(data[6])
                    faceAttrMainY = parseInt(data[7])
                    faceAttrMainGender = !!parseInt(data[8])
                ...
                try {
                    let data = a.slice(1, a.length).replaceAll(",", "").replaceAll("[", "").replaceAll("]", "").split(' ')
                    handX = parseInt(data[1])
                    handY = parseInt(data[2])
                } catch {
    ...
    export function koi_maskGetState(type: FaceMaskGetMenu): number {
        ...
        switch (type) {
            ...
            case 2:
                ...
                break;
            case 3:
                maskValue = faceMaskMainX
                faceMaskMainX = 0
                break;
            case 4:
                maskValue = faceMaskMainY
                faceMaskMainY = 0
                break;
            case 7:
                maskValue = faceMaskMainState
                faceMaskMainState = 0
                break;
            default:
                return 0;
    ...
    export function koi_attrGetNum(type: FaceAttrNumMenu): number {
        ...
        switch (type) {
            case 1:
                attrValue = faceAttrNumCount
                faceAttrNumCount = 0
                break;
            case 2:
                attrValue = faceAttrNumMen
                faceAttrNumMen = 0
                break;
            case 3:
                attrValue = faceAttrNumWomen
                faceAttrNumWomen = 0
                break;
            case 4:
                attrValue = faceAttrNumOM
                faceAttrNumOM = 0
                break;
            case 5:
                attrValue = faceAttrNumSmile
                faceAttrNumSmile = 0
                break;
            case 6:
                attrValue = faceAttrNumGlasses
                faceAttrNumGlasses = 0
                break;
        }
        return attrValue
    }
    ...
    export function koi_attrGetMainXY(type: FaceAttrMainXY): number {
        ...
        switch (type) {
            case 7:
                attrValue = faceAttrMainX
                faceAttrMainX = 0
                break;
            case 8:
                attrValue = faceAttrMainY
                faceAttrMainY = 0
                break;
        }
        return attrValue
    ...
    export function koi_attrGetMain(type: FaceAttrMain): boolean {
        ...
        switch (type) {
            case 9:
                attrValue = faceAttrMainGender
                faceAttrMainGender = false
                break;
            case 10:
                attrValue = faceAttrMainOM
                faceAttrMainOM = false
                break;
            case 11:
                attrValue = faceAttrMainSmile
                faceAttrMainSmile = false
                break;
            case 12:
                attrValue = faceAttrMainGlasses
                faceAttrMainGlasses = false
                break;
        }
        return attrValue
    }
    ...
    /**
     * @param keyword ;eg: "tiao-wu"
     * """"
     */
    //% blockId=koi_asr_register block="KOI asr register %keyword"
    //% group="Audio" weight=33 blockGap=41
    export function koi_asr_register(keyword: string): void {
        let str = `K64 ${keyword}`
        serial.writeLine(str)
    }
